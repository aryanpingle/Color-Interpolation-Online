...
const RESOURCE_VERSION = "0.0.0"
const RESOURCE_CACHE_NAME = `RESv${RESOURCE_VERSION}`
...
// For Debugging
const IS_PRODUCTION = self.registration.scope.includes("127.0.0.1")
const STOP_CACHING = 1 && IS_PRODUCTION
const log = (text, color="white") => IS_PRODUCTION ? console.log(`%c${text}`, `color: black; background-color: ${color};`) : ""
